											...
											<div class="col-sm-3">
												<div class="form-group">
													<button type="button" class="site-button"
														style="height: 115px; width: 90%;" id="memLoginBtn">로그인</button>
												</div>
											</div>
...
<!-- 															</button> -->
											...
											<div class="col-md-12">
												<div class="form-group">
													...
													<button type="button" id="testBtn1" style="background-color: white; float: right; border: 0px; position: relative; right: 20px;">TEST</button>
												</div>
											</div>
									...
									<form action="/login" method="post" id="entLoginForm" style="display: none">
										...
										<div class="row justify-content-center">
											...
											<div class="col-md-12">
												<div class="form-group">
													...
													<a href="/main/idpwfindForm.do" class="site-text-primary">비밀번호 찾기</a>&nbsp;&nbsp;|&nbsp;&nbsp;
													<a href="/main/registerForm.do" class="site-text-primary">회원가입</a>
													<button type="button" id="testBtn2" style="background-color: white; float: right; border: 0px; position: relative; right: 20px;">TEST</button>
												</div>
											</div>
										</div>
									</div>
...
$(function(){
	...
	var memLoginForm = $("#memLoginForm");
	var entLoginForm = $("#entLoginForm");
	var memLoginBtn = $("#memLoginBtn");
	...
	member.on("click", function(){
	     ...
	     $("#entLoginForm").css("display","none");
	     $("#memLoginForm input[name='username']").val("");
	     $("#memLoginForm input[name='password']").val("");
	});
	...
	// 개인 로그인
	$("#memLoginBtn").on("click", function(event) {
	...
	function memLogin() {
	    var memId = $("#accountId").val();
	    var memPw = $("#accountPswd").val();
